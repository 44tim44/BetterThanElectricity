...
public class BlockStairBase extends BlockBase
{
    ...
    protected BlockStairBase(Material material, String name)
    {
        super(material, name);
    ...
    {
        state.neighborChanged(worldIn, pos, Blocks.AIR, pos);
    ...
    {
        return super.onBlockActivated(worldIn, pos, state, playerIn, hand, EnumFacing.DOWN, 0.0F, 0.0F, 0.0F);
    }
